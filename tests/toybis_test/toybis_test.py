...
network_path = "data/data/networks/toybis.gml"
if path.isfile(network_path):
    G = nx.read_gml(network_path, destringizer= int)
else : 
    print("Creating the network ...")
    import data.data_queries.toybis_query
    G = nx.read_gml(network_path, destringizer= int)
...
network_display_path = "test/toybis_test/toybis_network.png"
...
tree_path = "data/data/percolation_trees/toybis_tree.npy"
...
cluster_path = "data/data/clusters/toybis/cut/" + str(threshold) + "/"
...
pos = nx.get_node_attributes(G, "coords")
cut_display_path = "test/toybis_test/toybis_cut_clustering"+ str(threshold)+".png"
...
condensed_tree_path = "data/data/condensed_trees/toybis/" + str(min_size) + "/"
if path.exists(condensed_tree_path):
    condensed_tree = CondensedTree(path = condensed_tree_path + "/toybis_condensed_tree" + str(min_size) + ".npy")
else : 
    ...
    condensed_tree.save(condensed_tree_path + "/toybis_condensed_tree" + str(min_size) + ".npy")


# Display the condensed tree
print("Displaying the condensed tree ... \n")
condensed_displayed_path = "test/toybis_test/toybis_condensed_tree"+str(min_size)+".png"
...
cluster_path = "data/data/clusters/toybis/stability/" + str(min_size) + "/"
if path.exists(cluster_path):
...
cluster_condensed_display_path = "test/toybis_test/toybis_clusters_condensed_tree"+str(min_size)+".png"
...
stability_display_path = "test/toybis_test/toybis_stability_clustering"+ str(min_size)+".png"
