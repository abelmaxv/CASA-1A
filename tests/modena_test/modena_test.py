...
# Importing the modena model
print("Importing the network ... \n")

network_path = "data/data/networks/modena.gml"
node_dtypes = {'id': int}
if path.isfile(network_path):
    ...
    import data.data_queries.modena_query
...
network_display_path = "test/modena_test/modena_network.png"
...
tree_path = "data/data/percolation_trees/modena_tree.npy"
...
cluster_path = "data/data/clusters/modena/cut/" + str(threshold) + "/"
...
cut_display_path = "test/modena_test/modena_cut_clustering"+ str(threshold)+".png"
...
condensed_tree_path = "data/data/condensed_trees/modena/" + str(min_size) + "/"
if path.exists(condensed_tree_path):
    condensed_tree = CondensedTree(path = condensed_tree_path + "/modena_condensed_tree" + str(min_size) + ".npy")
else : 
    ...
    condensed_tree.save(condensed_tree_path + "/modena_condensed_tree" + str(min_size) + ".npy")


# Display the condensed tree
print("Displaying the condensed tree ... \n")
condensed_displayed_path = "test/modena_test/modena_condensed_tree"+str(min_size)+".png"
...
cluster_path = "data/data/clusters/modena/stability/" + str(min_size) + "/"
if path.exists(cluster_path):
...
cluster_condensed_display_path = "test/modena_test/modena_clusters_condensed_tree"+str(min_size)+".png"
...
stability_display_path = "test/modena_test/modena_stability_clustering"+ str(min_size)+".png"
