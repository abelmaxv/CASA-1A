...
plt.axis("off")
plt.savefig("test/toybis_test/toybis_network.png")
plt.close()
...
plt.title("Percolation tree of the toy bis model")
plt.savefig("test/toybis_test/toybis_percolation_tree.png")
plt.close()
...
nx.draw_networkx_edges(G,pos, edge_color= "#B0B0B0", arrows=False)
plt.title(f"Clustering of the toy bis model at threshold {threshold}")
plt.axis("off")
plt.savefig("test/toybis_test/toybis_clustering.png")
plt.close()
...
plt.title(f"Condensed tree of the toy bis model (min_size={min_size})")
...
plt.title(f"Condensed tree with clusters of the toy bis model (min_size={min_size})")
...
nx.draw_networkx_nodes(G,pos, node_color=node_colors, node_size=30)
nx.draw_networkx_edges(G,pos, edge_color= "#B0B0B0", arrows=False)
plt.title("Stability clustering for toy bis model")
plt.axis("off")
plt.savefig("test/toybis_test/toybis_stability_clustering.png")
plt.close()